...
@section('title', 'Historique - FootArena')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Historique de mes Réservations</h1>
        <p class="text-gray-600 mt-2">Consultez toutes vos réservations passées</p>
    </div>
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                        ...
                        <div class="flex flex-col items-end space-y-2">
                            <span class="inline-block px-4 py-2 rounded-full text-sm font-semibold
                                ...
                                @elseif($reservation->statut == 'annulee') bg-red-100 text-red-700
    ...
    @else
        <div class="bg-white rounded-lg shadow-lg p-12 text-center">
            ...
            <p class="text-xl text-gray-600 mb-6">Aucune réservation passée</p>
