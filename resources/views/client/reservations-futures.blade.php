...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Mes Réservations à Venir</h1>
        <p class="text-gray-600 mt-2">Consultez et gérez vos réservations futures</p>
    </div>
    ...
    @else
        <div class="bg-white rounded-lg shadow-lg p-12 text-center">
            ...
            <p class="text-xl text-gray-600 mb-6">Vous n'avez pas de réservations à venir</p>
